...
class SetTenantContext
{
    ...
    {
        // Cegah akses DB tenant jika tenant nonaktif (ambil dari instance global yang di-set TenantMiddleware)
        $tenant = app()->bound('tenant') ? app('tenant') : null;
        if ($tenant && array_key_exists('is_active', $tenant) && ($tenant['is_active'] === 0 || $tenant['is_active'] === '0' || $tenant['is_active'] === false)) {
