            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-gradient-info text-white">
                        <h5 class="mb-0"><i class="fas fa-chart-pie"></i> Customer Berdasarkan Status</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-gradient-success text-white">
                        <h5 class="mb-0"><i class="fas fa-chart-line"></i> Pertumbuhan Customer Tahun {{ \Carbon\Carbon::now()->year }}</h5>
                    </div>
                    <div class="card-body">
