    ...
    <div class="glass-card">
        <div class="card-left">
            <div class="branding-content">
                ...
                <h1 class="branding-title">Buat Password Baru</h1>
                <p class="branding-description">Pilih password baru yang kuat untuk mengamankan akun Anda.</p>
                <div class="feature-list">
                    <div class="feature-item">Minimal 8 karakter</div>
                    <div class="feature-item">Gunakan huruf & angka</div>
                    <div class="feature-item">Jangan berbagi password</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-right">
            ...
            <div class="card-header-custom">
                ...
                <p class="header-subtitle">Masukkan password baru untuk akun Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="input-group-custom">
                    <label for="password-confirm" class="input-label">Konfirmasi Password</label>
                    <input
                        id="password-confirm"
                        type="password"
                        class="input-field"
