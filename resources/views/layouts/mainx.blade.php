...
<head>
  ...
  <title>ISP Ticketing | @yield('title')</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="{{url('dashboard/dist/img/AdminLTELogo.png')}}"
           alt="AdminLTE Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">TRIKAMEDIA</span>
    </a>
  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <div class="col-12 p-3 float-sm-right">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020-2021 duwija.ptr@gmail.com</strong> All rights
    reserved.
  </footer>
