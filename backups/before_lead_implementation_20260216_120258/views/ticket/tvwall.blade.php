...
<head>
  ...
  <style>
    ...
    .ticket-footer { position:relative; padding-bottom:18px; }
    .time-row { position:absolute; bottom:0; left:8px; right:8px; display:flex; justify-content:space-between; align-items:center; font-size:0.8rem; }
