...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-layer-group text-primary"></i> Group Ticket Management</h1>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container-fluid">
          ...
          <div class="col-lg-4 col-6">
            <div class="small-box bg-gradient-navy" style="margin-bottom: 10px;">
              <div class="inner" style="padding: 10px 10px 5px 10px;">
                ...
                <p style="font-size: 0.75rem; margin-bottom: 0;">Total Groups</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label><i class="fas fa-calendar-check text-primary"></i> Start Date</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                  </div>
                  <input type="text" name="date_from" class="form-control datetimepicker-input" data-target="#date_from_picker" placeholder="YYYY-MM-DD" value="{{date('Y-m-01')}}" />
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label><i class="fas fa-calendar-check text-primary"></i> End Date</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                  </div>
                  <input type="text" name="date_end" class="form-control datetimepicker-input" data-target="#date_end_picker" placeholder="YYYY-MM-DD" value="{{date('Y-m-d')}}" />
            ...
            <div class="col-md-12 text-right">
              <button type="button" id="groupticket_filter" class="btn btn-primary btn-sm">
    ...
    <div class="card shadow-sm">
      <div class="card-header card card-primary card-outline  shadow-sm  shadow-sm">
        <h3 class="card-title"><i class="fas fa-table"></i> Group Ticket List</h3>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table id="table-groupticket-list" class="table table-bordered table-striped table-hover">
