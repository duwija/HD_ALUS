...
<body>
    <div class="container">
        <div class="selection-container">
            ...
            <div class="customer-card" onclick="window.location.href='{{ url('/tagihan/view-invoice/' . $customer->id) }}'">
            ...
            <div class="text-center mt-4">
                <p class="text-white">
                    <i class="fas fa-info-circle"></i> Klik pada kartu pelanggan untuk melihat tagihan
                </p>
            </div>
        </div>
    </div>
