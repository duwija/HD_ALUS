      ...
      <div class="row mb-3">
          ...
          <div class="card card-danger">
            <div class="card-header">
              ...
              <div class="card-tools">
                <span class="badge badge-light">Total: {{ $totalDeletedCustomers }}</span>
              </div>
            </div>
            <div class="card-body">
              <canvas id="deletedCustomersChart" height="150"></canvas>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="card card-warning">
            <div class="card-header">
              <h3 class="card-title">
                <i class="fas fa-box"></i> Deleted Customers by Plan
              </h3>
            </div>
            <div class="card-body">
        ...
        <div class="col-lg-4">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">
                <i class="fas fa-store"></i> Deleted Customers by Merchant
              </h3>
            </div>
            <div class="card-body">
              <canvas id="merchantChart" height="150"></canvas>
            </div>
          </div>
        </div>
      </div>
...
$(document).ready(function() {
  ...
  var planChart = new Chart(planCtx, {
    ...
    data: {
      labels: planLabels,
      datasets: [{
        label: 'Deleted Customers by Plan',
        data: planData,
        backgroundColor: [
  ...
  var merchantLabels = @json($merchantLabels);
  var merchantData = @json($merchantData);
  ...
  var merchantChart = new Chart(merchantCtx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'Deleted Customers by Merchant',
        data: merchantData,
        backgroundColor: [
          'rgba(255, 99, 132, 0.8)',
          'rgba(54, 162, 235, 0.8)',
  ...
  $('#id_merchant, #id_status, #id_plan').on('change', function() {
    applyFilters();
  });
