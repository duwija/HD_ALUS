...
$(document).ready(function() {
    ...
    console.log('Initial workflow:', workflowSteps);
        ...
        if (workflowSteps.length === 0) {
            html = `
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> Belum ada workflow step. Tambahkan step baru di bawah.
                </div>
            `;
            ...
            html = `
                <div class="alert alert-secondary">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <strong>Current Workflow Steps:</strong>
