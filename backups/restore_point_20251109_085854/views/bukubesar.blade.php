...
#bukubesar-table tbody tr.bg-light td {
  padding: 12px;
}
...
#bukubesar-table tbody tr.bg-secondary td {
  padding: 12px;
}
...
/* Saldo Akhir specific colors (lighter for dark background) */
