...
# ==========================================================
# Usage:
# python3 reboot_cdata_epon_ont.py <ip> <username> <password> <port> <timeout> <card> <pon> <onu>
# Example:
# python3 reboot_cdata_epon_ont.py 103.156.75.196 root public 1612 10 1 1 1
#
...
#   OLT(config-epon-0/<card>)# ont reboot <pon> <onu>
...
# in "ont reboot <pon> <onu>" is then the port NUMBER WITHIN that card (1-4 on
# units seen so far), and <onu> the ONU id — same two-argument shape as GPON's
# "ont reboot <pon> <onu>", just scoped to the already-selected card.
