...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _loadData();
    NotificationService.refreshUnread();
  ...
  Widget build(BuildContext context) {
    final today = DateFormat('EEEE, d MMMM yyyy', 'id').format(_now);
        ...
        child: Column(
          ...
          children: [
            ...
            if (att == null)
              ...
              Column(
                children: [
                  if (att.shiftName != null)
                    _infoRow('Shift', att.shiftName!, Icons.work_outline, const Color(0xFF1565C0)),
